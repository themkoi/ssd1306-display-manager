...
void oledFadeOutImplementation() {
    if (fading || displaying) return; // Check if already fading or displaying
...
void startScrollLeftImplementation(uint8_t startPage, uint8_t endPage, uint8_t speed) {
    uint8_t interval;
    switch (speed) {
        case 5: interval = 0b000; break;
        case 64: interval = 0b001; break;
        case 128: interval = 0b010; break;
        case 256: interval = 0b011; break;
        case 3: interval = 0b100; break;
        case 4: interval = 0b101; break;
        case 25: interval = 0b110; break;
        case 2: interval = 0b111; break;
        default: interval = 0b000; break;
    }
    delay(10);
