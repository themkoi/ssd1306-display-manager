...
void startScrollLeftImplementation(uint8_t startPage, uint8_t endPage, uint16_t speed)
{
    uint8_t interval;
    switch (speed)
    {
...
void startScrollRightImplementation(uint8_t startPage, uint8_t endPage, uint16_t speed)
{
    uint8_t interval;
    switch (speed)
    {
